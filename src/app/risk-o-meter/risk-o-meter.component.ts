...
export class RiskOMeterComponent implements OnInit {
    ...
    start() {
        ...
        let interval = setInterval(() => {
            console.log('lopp-> ' + this.logs[i].VehicleSpeed);
            i++;
            this.chartSpeed.removePoint(0);
            this.chartSpeed.addPoint(this.logs[i].VehicleSpeed, 0);
            this.chartRpm.removePoint(0);
            this.chartRpm.addPoint((this.logs[i].TransmissionSpeedG182 / 1000), 0)
            this.engineRpm.removePoint(0);
            this.engineRpm.addPoint((this.logs[i].EngineSpeed / 1000), 0)
            this.gear = this.logs[i].EngagedGear
